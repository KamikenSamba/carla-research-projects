...
except ImportError:  # pragma: no cover - optional MP4 helper
    imageio_ffmpeg = None
...
def animate_trajectories(
    ...
    fig.tight_layout()
    save_kwargs = {"fps": fps, "dpi": dpi}
    if output_path.suffix.lower() == ".gif":
        save_kwargs["writer"] = "pillow"
    elif output_path.suffix.lower() == ".mp4" and imageio_ffmpeg is not None:
        plt.rcParams["animation.ffmpeg_path"] = imageio_ffmpeg.get_ffmpeg_exe()
    anim.save(output_path, **save_kwargs)
