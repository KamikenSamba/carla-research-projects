...
def configure_paper_fonts() -> None:
    """Use a Japanese-capable font when one is installed."""
    ...
    selected_fonts = [font for font in preferred_fonts if font in available]
    selected_fonts.append("sans-serif")
    mpl.rcParams["font.family"] = selected_fonts
