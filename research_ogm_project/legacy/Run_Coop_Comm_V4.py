...
EGO_SPAWN_X   =  15.0  # 交差点手前の WORLD X
EGO_SPAWN_Y   =  70.0 # 交差点中心のレーン上 Y
...
GRID_ORIGIN_X = 42.0            # ← 交差点中心の WORLD X に書き換える
GRID_ORIGIN_Y = 56.0            # ← 交差点中心の WORLD Y に書き換える
...
Z_MAX_WORLD = 2.50   # 車両・歩行者などを主に見るための上限（参考論文に合わせて調整）
...
def main():
    ...
    try:
        ...
        rsu_tf = carla.Transform(
            carla.Location(x=42.00, y=42.50, z=2.0),
